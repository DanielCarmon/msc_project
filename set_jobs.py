...
def name_it(use_deepset,split,dataset,n_train_classes,lr,n_iters):
...
options = product(deepset_list,split_list,dataset_list,n_train_classes_list,lr_list,n_iter_list)
for opt in options:
